...
public class EmbeddingService : IEmbeddingService
{
    ...
    public EmbeddingService(HttpClient httpClient, IOptions<EtlSettings> settings)
    {
    ...
    public async Task ProcessDatasetAsync(int datasetMetadataID)
    {
        ...
        {
            Console.WriteLine($"Error: Failed to trigger dataset processing in Python service: {ex.Message}");
